...
$(document).on('ready page:load', function (){
 $('li img').on('click',function(){
    ...
    var lk = $(this).next('.like').attr('href');
    ...
    if($(this).next('.like').attr('data-method') == "post")
    {
      html += '<a href="' + lk + '", data-method="post" ><i class="glyphicon glyphicon-thumbs-up"></i> Like</a>';
      // $(this).next('.like').attr('data-method',"delete");
    }
    else
    {
      html += '<a href="' + lk + '", data-method="delete"><i class="glyphicon glyphicon-thumbs-down"></i> Unlike</a>';
    }
